gg.alert("ENQUANTO TO ATUALIZANDO A NOVA ATT VOU DEIXAR ESSA ANTIGA POR ENQUANTO, CUIDADO Q ALGUNS HACKS TAO DANDO BAN")
goto START
::START::
menu= gg.choice({
...
,'➁➁.♦ɴᴏᴠᴏ ᴡᴀʟʟʜᴀᴄᴋ♦'
,'➁➂.♠ᴀɪᴍʙᴏᴛ ᴛᴏᴅᴀs ᴀs ᴀʀᴍᴀs(ᴀɪɴᴅᴀ ᴇᴍ ᴛᴇsᴛᴇ, ᴀʟᴛᴇʀᴀʀ ᴛᴏᴅᴏs ᴠᴀʟᴏʀᴇs ᴅᴏᴜʙʟᴇ ᴘᴀʀᴀ 999999)♠'
,'➁➃.♦ᴘᴇʀsᴏɴᴀɢᴇᴍ ᴘᴜʟᴀ ʟᴏɴɢᴇ♦'
